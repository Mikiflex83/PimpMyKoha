...
Avant toute diffusion publique, choisir la licence du projet à partir de `docs/LICENCE-AVANT-PUBLICATION.md`.
...
10. Dans **Summary**, saisir `Pimp My Koha 3.44.0`.
...
4. Saisir exactement `v3.44.0`.
5. Titre : `Pimp My Koha 3.44.0`.
...
https://VOTRE-COMPTE.github.io/pimp-my-koha/releases/3.44.0/bootstrap.js
```
...
(function () {
  ...
  s.src = "https://VOTRE-COMPTE.github.io/pimp-my-koha/releases/3.44.0/bootstrap.js";
  s.async = false;
...
Cette installation est **épinglée en 3.44.0** : une nouvelle release GitHub ne remplace rien automatiquement.
