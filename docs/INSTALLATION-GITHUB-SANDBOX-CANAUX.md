...
10. Dans **Summary**, saisir `Pimp My Koha 3.43.2`.
...
4. Saisir exactement `v3.43.2`.
5. Titre : `Pimp My Koha 3.43.2`.
...
https://VOTRE-COMPTE.github.io/pimp-my-koha/releases/3.43.2/bootstrap.js
```
...
(function () {
  ...
  s.src = "https://VOTRE-COMPTE.github.io/pimp-my-koha/releases/3.43.2/bootstrap.js";
  s.async = false;
...
Cette installation est **épinglée en 3.43.2** : une nouvelle release GitHub ne remplace rien automatiquement.
