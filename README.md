...
```text
https://VOTRE-COMPTE.github.io/VOTRE-DEPOT/releases/3.43.0/
```
...
(function () {
  ...
  s.src = "https://VOTRE-COMPTE.github.io/VOTRE-DEPOT/releases/3.43.0/bootstrap.js";
  s.async = false;
...
**Pour mettre à jour tous les postes**, remplacer uniquement le numéro de version dans l'URL de `IntranetUserJS`, par exemple `3.43.0` → `3.44.0`, après avoir lu la release et effectué la recette souhaitée.
