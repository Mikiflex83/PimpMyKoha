...
const index={
  ...
  channels:{stable:'3.43.1',canary:'3.44.0-canary.1',dev:'3.44.0-dev.1'},
  releases:{
    '3.43.1':{version:'3.43.1',runtimeRoot:'https://example.test/releases/3.43.1/'},
...
assert.equal(r.resolution.version,'3.43.1');
